          ...
          <div className="tile is-ancestor">
            <div className="tile is-vertical is-8">
                ...
                <div className="tile is-parent is-vertical">
                  <article className="tile is-child notification is-info">
                    ...
                    <p className="content">
                      ...
                      encouragement and cooperation, I am leading a pain-free
                      life now.
                    </p>
                  </article>
              ...
              <div className="tile is-parent">
                <article className="tile is-child notification is-info">
                  ...
                  <h4 className="subtitle">Gym Member</h4>
                  <p className="content">
                    When I first joined the gym, I was unable to do any
                    exercises and decided to quit. Divakar encouraged me to
                    continue gym and and planned a 30 day workout plan to see
                    the most satisfying results. My stamina and confidence
                    levels increased. I really thank Divakar for the
                    encouragement.
                  </p>
                </article>
              </div>
            ...
            <div className="tile is-parent">
              <article className="tile is-child notification is-danger">
                ...
                <p className="content">
                  Previously, I tried various methods like dieting, yoga, etc
                  yet couldn't get any results. As I started developing knee
                  pains and restlesness, I decided to join a gym with Mr.
                  Divakar as my personal trainer and immediately felt difference
                  in my daily activities.
                  <br />
                  <br />I joined on January 22<sup>nd</sup> and spite of being
                  an asthma and PCOD patient, I reduced over 5 kg of weight
                  within 3 weeks. Initially, I started off slowly. But, with
                  kind, proper guidance from Divakar, I was soon able to do all
                  the tougher and advanced workouts like the other gym members.
                  <br />
                  <br />
